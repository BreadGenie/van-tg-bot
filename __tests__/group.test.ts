import { sendGroup } from '../src/modules/group';
...
describe('/group tests', () => {
  ...
  test('should check if group details are returned properly', async () => {
    const [groupPicLink, groupDescription] = await sendGroup('bts');
    const details =
